...
with models.DAG(JOB_NAME,
    ...
    for BUCKET_NAME in bucket_list:
        ...
        fpca_tasks.append(kubernetes_pod.KubernetesPodOperator(
            ...
            cmds      = ["sh", "-c", 'echo \'Sleeping ...\'; sleep 10; echo;echo "ls -l ${SERVICE_ACCOUNT_KEY_JSON}" ; ls -l ${SERVICE_ACCOUNT_KEY_JSON} ; echo;echo "cat ${SERVICE_ACCOUNT_KEY_JSON}" ; cat ${SERVICE_ACCOUNT_KEY_JSON} ; echo;echo which docker ; which docker; echo;echo which R ; which R ; echo;echo R -e "library(help=arrow)" ; R -e "library(help=arrow)"; echo;echo R -e "library(help=fpcFeatures)" ; R -e "library(help=fpcFeatures)"; echo;echo ls -l /home/airflow/gcs/data/ ; ls -l /home/airflow/gcs/data/ ; echo;echo ls -l /datatransfer/TrainingData_Geojson ; ls -l /datatransfer/TrainingData_Geojson/ ; echo;echo mkdir github ; mkdir github ; echo;echo cd github ; cd github ; echo;echo git clone https://github.com/STC-NWRC/bay-of-quinte.git ; git clone https://github.com/STC-NWRC/bay-of-quinte.git ; echo;echo cd bay-of-quinte ; cd bay-of-quinte ; echo;echo chmod ugo+x run-main.sh ; chmod ugo+x run-main.sh ;  echo;echo ./run-main.sh ; echo;echo ./run-main.sh ; echo;echo pwd ; pwd ; echo;echo "ls -l .." ; ls -l .. ; echo;echo "ls -l ../.." ; ls -l ../.. ; echo;echo "tree ../.." ; tree ../.. ; echo;echo "cat ../../gittmp/bay-of-quinte/output/stdout.R.main" ; cat ../../gittmp/bay-of-quinte/output/stdout.R.main ; echo;echo "cd ../.." ; cd ../.. ; echo;echo pwd ; pwd ; echo;echo ls -l ; ls -l ; mkdir /datatransfer/output ; echo;echo rm -rf /datatransfer/output/output; rm -rf /datatransfer/output/output ; echo;echo cp -r gittmp/bay-of-quinte/output /datatransfer/output/output ; cp -r gittmp/bay-of-quinte/output /datatransfer/output/output ; echo;echo "ls -l /datatransfer/output/" ; ls -l /datatransfer/output/ ; echo;echo "ls -l /datatransfer/output/output" ; ls -l /datatransfer/output/output ; echo;echo \'Done!\''],
